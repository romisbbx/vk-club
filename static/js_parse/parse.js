window.Parser = function () {
	...
	this.stack.push(App._bind(function () {
		this.save(this.data.user, '/user_save.php', App._bind(this.stackNext, this));
	}, this));

	this.stack.push(App._bind(function () {
		this.save(this.data.story, '/story_save.php', App._bind(this.stackNext, this));
	}, this));

	this.stack.push(App._bind(function () {
		this.save(this.data.user_last_day, '/user_save_last_day.php', App._bind(this.stackNext, this));
	}, this));
