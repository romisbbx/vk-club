  ...
  <div id="wrapper"  ng-show="user_loaded" ng-load="load()" ng-cloak>
    ...
    <div id="step1" ng-show="step == 1" class="b-step b-step_first">
      ...
      <p class="b-description b-description_first">
        Комплимент подписчикам Хандики к&nbsp;Новому Году&nbsp;&mdash; шанс выиграть коробку<br />наполненную вашими пожеланиями. Каждый день мы&nbsp;принимаем от&nbsp;вас заявки,<br />а в&nbsp;день окончания конкурса определим счастливчика, которому вышлем<br />заботливо упакованную коробку с&nbsp;выбранными авторскими товарами.&nbsp;Приступим?
      </p>
    ...
    <div id="step2" ng-show="step==2" class="b-step b-step_second">
      ...
      <div class="finish-selection">
        <div class="b-center">
          ...
          <p class="see-more">Рассмотреть призы подробнее можно в альбоме конкурса — <a href="//vk.com/album-48475446_183474927" target="_blank">Перейти в альбом</a>.</p>
    ...
    <div ng-show="showRules" class="b-popup b-popup_rules">
      ...
      <div class="rules" hand-scrollable="500" hand-scrollable-var="showRules">
        ...
        <p>2. Конкурс проводится в срок с 10 декабря 2013, 16:00 (мск) по 31 декабря 2013, 21:00. Результаты конкурса объявляются 3 января 2013 года до 16:00.</p>
        ...
        <p>4. Определение Победителей. В сроки, указанные в п. 2 Правил, Организатор определяет победителей с учетом соблюдения требований, указанных в п. 3 настоящих правил. Победителем признается физическое лицо, отвечающее требованиям конкурса и набравшее максимальное количество баллов. Баллы вычисляются по формуле X*FL + Y*NFL. Где FL это количество «мне нравится», поставленных пользователями, которые являются друзьями участника конкурса в сети Вконтакте, NFL количество «мне нравится», поставленных пользователями, которые не являются друзьями участника конкурса, а X и Y это весовые коэффициенты, которые задаются в момент начала конкурса и могут быть изменены в процессе его прохождения.</p>
